<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterNew.aspx.cs" Inherits="EBV.RegisterNew" %>
                ...
                <p>&nbsp;</p>
						<div class="left margin">
							...
							<div class="input-group">
                                <asp:TextBox ID="txtName" runat="server" placeholder="Name" ValidationGroup="A"></asp:TextBox>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                    ErrorMessage="Enter your Name" ForeColor="Red" 
                                    ValidationGroup="A" ControlToValidate="txtName"></asp:RequiredFieldValidator>
							</div>
						</div>
						<%--<div class="left">
